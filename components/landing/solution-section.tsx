  ...
  return (
    <section id="solucao" className="section-space overflow-hidden bg-primary-dark text-white">
      <div className="container-page grid items-center gap-14 lg:grid-cols-[.8fr_1.2fr]">
        <SectionHeading align="left" eyebrow="A solução" title="Um único lugar para controlar todo o fluxo do seu projeto." description="Da primeira conversa ao pagamento, cada informação fica conectada ao contexto certo — fácil de encontrar, atualizar e acompanhar." />
